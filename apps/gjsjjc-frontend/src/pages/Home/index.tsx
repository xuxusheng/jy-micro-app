...
export const HomePage: FC = () => {
    ...
    const getMiddleScreenPage = ({area, pn, ps, deviceName, dataName}: any, getTop?: boolean) => {
        setLoading(true)
    ...
    useEffect(() => {
        Promise.allSettled([api.getAreaOptions(), api.getDeviceNameOptions()]).then((res: any) => {
    ...
    return <div className={styles.container}>
        ...
        <div className={styles.contentWrap}>
            ...
            <div className={styles.tableWrap}>
                ...
                <Table dataSource={tableData?.items || []} columns={columns} bordered
                       pagination={{
                           size: 'small',
